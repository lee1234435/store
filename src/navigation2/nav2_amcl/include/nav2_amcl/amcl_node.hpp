...
{
public:
  void apriltagPoseCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg); // AprilTag 콜백 함수 추가
...
private:
  ...
  // rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr corrected_pose_sub_;
